...
class Config
{
    ...
    const SIGN_TICKET_BY_TEMPLATE       = 'template';
    ...
    const CHANNEL_FORM_BUILDER = 'form_builder';
     ...
     * @return string
     */
    public function getGeneralSignTicketTemplate($store = null)
    {
        return $this->scopeConfig->getValue(
            'helpdesk/general/sign_ticket_template',
            ScopeInterface::SCOPE_STORE,
            $store
        );
    }
     ...
     * @return array
     */
    public function getGeneralLockedStatusList()
    {
        $value = (string)$this->scopeConfig->getValue(
            'helpdesk/general/locked_status_list',
     ...
     * @return string
     */
    public function getIsCcAdded($store = null)
    {
        return $this->scopeConfig->getValue(
            'helpdesk/notification/is_cc_added',
            ScopeInterface::SCOPE_STORE,
            $store
        );
    }
