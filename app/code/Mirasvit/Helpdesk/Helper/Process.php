...
class Process
{
    ...
    protected function validateInput($post) {
        $nameValidator = new \Magento\Framework\Validator\Alnum();
        $nameValidator->setAllowWhiteSpace(true);
        if (isset($post['customer_name']) && !$nameValidator->isValid(trim($post['customer_name']))) {
