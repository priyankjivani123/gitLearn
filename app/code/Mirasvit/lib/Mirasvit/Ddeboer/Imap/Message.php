    ...
    */
    ...
    public function getFlagHeaders()
    {
        if (null === $this->flagHeaders) {
            ...
            $headers = imap_headerinfo($this->stream, $this->messageNumber);
    ...
    public function checkAutoresponse()
    {
        $autoHeaders = [
            ...
            // this header is used only by Microsoft Exchange
            // and it's purpose is to prevent other Exchange servers from sending auto-replies in response to an email with that header.
            // It doesn't mean that this email is garbage at all.
