...
use Mirasvit\Assistant\Model\Rule\ConditionRule\Condition\Product\AbstractProductCondition;
...
class Product extends AbstractCondition
{
    ...
    public function collectValidatedAttributes(Collection $productCollection): self
    {
        ...
        if (!in_array($attribute, ['category_ids', 'qty', 'price_diff', 'percent_discount', 'set_as_new', 'stock_status', 'is_salable'])) {
            if ($this->getAttributeObject()->isScopeGlobal()) {
                ...
                $attr = $this->eavConfig->getAttribute('catalog_product', $attribute);

                if ($attr->getAttributeId()) { // attribute can be deleted at this moment
